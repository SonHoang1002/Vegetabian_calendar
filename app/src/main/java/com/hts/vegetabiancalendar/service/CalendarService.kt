...
class MyCalendarService {
    ...
    private fun convertSolar2Lunar(): MyLunarDate {
        ...
        val result = MyLunarDate(lunarDay, lunarMonth, muoican, congiap)
    ...
    fun isCurrentLunarMonthFull(): Boolean {
        ...
        val nextMonthStart = getNewMoonDay(k + 1, timeZone)

        val numberOfDays = nextMonthStart - currentMonthStart
